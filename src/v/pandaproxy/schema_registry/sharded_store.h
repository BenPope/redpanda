...
public:
    ...
    ss::future<schema_definition> validate(const referenced_schema& ref);

    ///\brief Provide a minimal check and normalise the input
    ss::future<schema_definition> sanitize(const referenced_schema& ref);
