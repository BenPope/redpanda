...
SEASTAR_THREAD_TEST_CASE(test_consume_to_store) {
    ...
    auto s_res = s.get_subject_schema(
                   ...
                   .get();
    BOOST_REQUIRE_EQUAL(s_res.ref.def(), string_def0);

    pps::referenced_schema::references refs{
    ...
    auto s_ref_res = s.get_subject_schema(
                       ...
                       .get();
    BOOST_REQUIRE_EQUAL(s_ref_res.ref.def(), string_def0);
    BOOST_REQUIRE_EQUAL(s_ref_res.ref.sub(), subject0);
    BOOST_REQUIRE_EQUAL(s_ref_res.id, id1);
    BOOST_REQUIRE_EQUAL_COLLECTIONS(
      s_ref_res.ref.refs().begin(),
      s_ref_res.ref.refs().end(),
      refs.begin(),
      refs.end());
