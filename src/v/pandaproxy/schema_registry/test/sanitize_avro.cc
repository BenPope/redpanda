...
pps::raw_schema_definition not_minimal{
  R"({
   "type": "record",
   "name": "myrecord",
...
pps::raw_schema_definition not_minimal_sanitized{
  R"({"type":"record","name":"myrecord","fields":[{"type":"string","name":"f1"}]})",
  pps::schema_type::avro};

pps::raw_schema_definition leading_dot{
...
pps::raw_schema_definition leading_dot_sanitized{
  R"({"type":"record","name":"record","fields":[{"name":"one","type":["null",{"fields":[{"name":"f1","type":["null","string"]}],"name":"r1","type":"record"}]},{"name":"two","type":["null","r1"]}]})",
  pps::schema_type::avro};

pps::raw_schema_definition leading_dot_ns{
...
pps::raw_schema_definition leading_dot_ns_sanitized{
...
pps::raw_schema_definition debezium_schema{
